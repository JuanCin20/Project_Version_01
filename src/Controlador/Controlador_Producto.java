...
public class Controlador_Producto {
    ...
    public boolean Insertar_Producto(Modelo_Producto Obj_Modelo_Producto) throws SQLException {
        try {
    ...
    public boolean Check_Nombre_Producto(String Nombre_Producto) throws SQLException {
        try {
    ...
    public ArrayList<String> ArrayList_Nombre_Categoria_Producto() throws SQLException {
    ...
    public ArrayList<String> ArrayList_Nombre_Marca_Producto() throws SQLException {
        ArrayList<String> Obj_ArrayList_String = new ArrayList<>();
        try {
    ...
    public ArrayList<Modelo_Producto> ArrayList_Modelo_Producto() throws SQLException {
    ...
    public boolean Eliminar_Producto(int ID_Producto) throws SQLException {
        try {
    ...
    public boolean Restaurar_Producto(int ID_Producto) throws SQLException {
        try {
    ...
    public boolean Editar_Producto(Modelo_Producto Obj_Modelo_Producto, int ID_Producto) throws SQLException {
        try {
    ...
    public boolean Editar_Stock_Producto(int ID_Producto, int Stock_Producto) throws SQLException {
        try {
