...
public class Controlador_Categoria_Producto {
    ...
    public boolean Insertar_Categoria_Producto(Modelo_Categoria_Producto Obj_Modelo_Categoria_Producto) throws SQLException {
        try {
    ...
    public boolean Check_Nombre_Categoria_Producto(String Nombre_Categoria_Producto) throws SQLException {
        try {
    ...
    public ArrayList<Modelo_Categoria_Producto> ArrayList_Modelo_Categoria_Producto() throws SQLException {
    ...
    public boolean Eliminar_Categoria_Producto(int ID_Categoria_Producto) throws SQLException {
        try {
    ...
    public boolean Restaurar_Categoria_Producto(int ID_Categoria_Producto) throws SQLException {
        try {
    ...
    public boolean Editar_Categoria_Producto(Modelo_Categoria_Producto Obj_Modelo_Categoria_Producto, int ID_Categoria_Producto) throws SQLException {
        try {
