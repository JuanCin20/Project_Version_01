...
public class Controlador_Marca_Producto {
    ...
    public boolean Insertar_Marca_Producto(Modelo_Marca_Producto Obj_Modelo_Marca_Producto) throws SQLException {
        try {
    ...
    public boolean Check_Nombre_Marca_Producto(String Nombre_Marca_Producto) throws SQLException {
        try {
    ...
    public boolean Check_Telefono_Marca_Producto(String Telefono_Marca_Producto) throws SQLException {
        try {
    ...
    public boolean Check_E_Mail_Marca_Producto(String E_Mail_Marca_Producto) throws SQLException {
        try {
    ...
    public boolean Check_Direccion_Marca_Producto(String Direccion_Marca_Producto) throws SQLException {
        try {
    ...
    public ArrayList<Modelo_Marca_Producto> ArrayList_Modelo_Marca_Producto() throws SQLException {
    ...
    public ArrayList<ArrayList<Object>> ArrayList_ArrayList_Object() throws SQLException {
    ...
    public boolean Eliminar_Marca_Producto(int ID_Marca_Producto) throws SQLException {
        try {
    ...
    public boolean Restaurar_Marca_Producto(int ID_Marca_Producto) throws SQLException {
        try {
    ...
    public boolean Editar_Marca_Producto(Modelo_Marca_Producto Obj_Modelo_Marca_Producto, int ID_Marca_Producto) throws SQLException {
        try {
